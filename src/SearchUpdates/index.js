...
export default function SearchUpdates({ state, onStateChange, children }) {
  ...
  useDeepCompareEffect(() => {
    setSearchState({ layout: 'list', ...state, configure: { filters: '', hitsPerPage: 24, ...state.configure } });
  }, [state]);
  ...
  return (
    <InstantSearch searchClient={searchClient} indexName="Updates" searchState={searchState} onSearchStateChange={onSearchStateChange}>
